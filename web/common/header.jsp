                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${sessionScope.USER.username eq 'admin'}">
                                    <a class="nav-link fw-bold text-primary mx-2"
                                ...
                                <a class="nav-link text-success fw-bold mx-2"
                                    href="${pageContext.request.contextPath}/views/customer/my-reviews.jsp">My
                                    Reviews</a>
