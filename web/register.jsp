...
<head>
    ...
    <style>
        .strength-meter { height: 5px; background-color: #e9ecef; border-radius: 3px; margin-top: 5px; transition: all 0.3s; }
                    ...
                    <form action="${pageContext.request.contextPath}/RegisterServlet" method="POST" id="registerForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" id="txtPassword" name="txtPassword" class="form-control border-end-0" required>
                                <button class="btn btn-outline-secondary border-start-0 border bg-white" type="button" onclick="toggleVis('txtPassword', 'eye1')">
                                    <i class="bi bi-eye-slash" id="eye1"></i>
                                </button>
                            </div>
                            <div id="strengthMeter" class="strength-meter"></div>
                            <small id="strengthText" class="text-muted mt-1 d-block">Enter a password to see its strength.</small>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Confirm Password</label>
                            <div class="input-group">
                                <input type="password" id="txtConfirm" name="txtConfirmPassword" class="form-control border-end-0" required>
                                <button class="btn btn-outline-secondary border-start-0 border bg-white" type="button" onclick="toggleVis('txtConfirm', 'eye2')">
