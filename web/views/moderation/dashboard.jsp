...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="${pageContext.request.contextPath}/LoginServlet" class="btn btn-outline-secondary">Trang chủ / Đăng xuất</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="${pageContext.request.contextPath}/ModeratorServlet" method="POST" class="d-inline">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-success me-1">Cho phép</button>
                                </form>
                                <form action="${pageContext.request.contextPath}/ModeratorServlet" method="POST" class="d-inline">
                                    <input type="hidden" name="reviewId" value="${r.reviewId}">
