        ...
        <div class="row">
            <div class="col-md-5 mb-4">
                <div class="card shadow-sm border-0 rounded-3 sticky-top" style="top: 20px;">
                    <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop" class="card-img-top" alt="Product Image">
                    
                    <div class="card-body p-4">
                        <h2 class="fw-bold text-primary mb-2">${not empty requestScope.PRODUCT ? requestScope.PRODUCT.name : 'Unknown Product'}</h2>
                        <div class="mb-3">
                            <span class="badge bg-info text-dark"><i class="bi bi-tag-fill"></i> Category: ${requestScope.PRODUCT.category}</span>
                        ...
                        <div class="d-grid mt-3">
                            <a href="${pageContext.request.contextPath}/views/customer/write-review.jsp?id=${requestScope.PRODUCT.productId}" class="btn btn-success btn-lg fw-bold shadow-sm">
            ...
            <div class="col-md-7">
                <div class="card shadow-sm border-0 bg-white rounded-3 p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                        ...
                        <a href="${pageContext.request.contextPath}/views/customer/write-review.jsp?id=${requestScope.PRODUCT.productId}" class="btn btn-outline-success fw-bold btn-sm px-3">
                        ...
                        <c:choose>
                                ...
                                <c:forEach var="r" items="${requestScope.REVIEWS}">
                                    <div class="review-item mb-4 p-3 bg-light rounded-3 shadow-sm border-start border-4 border-primary">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div>
                                                <strong class="text-dark d-block"><i class="bi bi-person-circle text-secondary me-1"></i> User ID: ${r.userId}</strong>
                                                <div class="text-warning small mt-1">
                                                    <c:forEach begin="1" end="${r.rating}">&#9733;</c:forEach>
                                                    <c:forEach begin="${r.rating + 1}" end="5"><span class="text-muted">&#9734;</span></c:forEach>
                                                </div>
                                            </div>
                                            <span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill"><small><i class="bi bi-shield-check"></i> Verified</small></span>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top">
                                            ...
                                            <button class="btn btn-sm btn-outline-secondary px-2 py-0"><small><i class="bi bi-hand-thumbs-up"></i> Helpful</small></button>
                                        </div>
                                    </div>
                                </c:forEach>
                            </c:when>
                            ...
                            <c:otherwise>
                                <div class="text-center text-muted py-5">
                                    ...
                                    <a href="${pageContext.request.contextPath}/views/customer/write-review.jsp?id=${requestScope.PRODUCT.productId}" class="btn btn-success fw-bold">
