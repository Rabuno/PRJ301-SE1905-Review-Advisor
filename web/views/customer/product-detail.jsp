                            ...
                            <div class="card shadow-sm border-0 rounded-3 sticky-top" style="top: 20px;">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <p class="text-muted lh-lg">
                                        Experience world-class service right in the heart of the city. We provide
                                        top-tier amenities, comfortable rooms, and breathtaking views to make your stay
                                        unforgettable.
                                    </p>
                        ...
                        <div class="col-md-7">
                            <div class="card shadow-sm border-0 bg-white rounded-3 p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                                    <h4 class="fw-bold mb-0"><i class="bi bi-chat-right-text text-primary"></i> Customer
                                        Reviews</h4>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty requestScope.REVIEWS}">
                                            <c:forEach var="r" items="${requestScope.REVIEWS}">
                                                <div
                                                    class="review-item mb-4 p-3 bg-light rounded-3 shadow-sm border-start border-4 border-primary">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div>
                                                            <strong class="text-dark d-block"><i
                                                                    class="bi bi-person-circle text-secondary me-1"></i>
                                                                User ID: ${r.userId}</strong>
                                                            <div class="text-warning small mt-1">
                                                                <c:forEach begin="1" end="${r.rating}">&#9733;
                                                                </c:forEach>
                                                                <c:forEach begin="${r.rating + 1}" end="5"><span
                                                                        class="text-muted">&#9734;</span></c:forEach>
                                                            </div>
                                                        </div>
                                                        <span
                                                            class="badge bg-success-subtle text-success border border-success-subtle rounded-pill"><small><i
                                                    ...
                                                    <div
                                                        ...
                                                        <small class="text-muted"><i class="bi bi-clock"></i> Posted:
                                                            ${r.createdAt}</small>
                                                        <button
                                                            class="btn btn-sm btn-outline-secondary px-2 py-0"><small><i
                                                                    class="bi bi-hand-thumbs-up"></i>
                                                                Helpful</small></button>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                        </c:when>
                                        ...
                                        <c:otherwise>
                                            <div class="text-center text-muted py-5">
                                                <h1 class="display-1 text-light mb-3"><i class="bi bi-journal-x"></i>
                                                </h1>
                                                <h5 class="fw-bold">No reviews yet</h5>
                                                <p class="mb-3">Be the first to share your experience about this place!
                                                </p>
                                                <a href="${pageContext.request.contextPath}/views/customer/write-review.jsp?id=${requestScope.PRODUCT.productId}"
