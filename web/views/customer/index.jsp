            ...
            <div class="container mt-4 mb-5">
                <div class="p-5 text-center bg-light rounded-3 shadow-sm mb-5">
                    ...
                    <form action="${pageContext.request.contextPath}/MainController" method="GET"
                        ...
                        <input type="text" name="txtSearch" class="form-control w-50 me-2"
                    ...
                    <c:choose>
                                    ...
                                    <div class="card h-100 shadow-sm card-product border-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted small mb-3">
                                                <i class="bi bi-tag-fill text-danger"></i> Description:
                                                ${product.description}
                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="${pageContext.request.contextPath}/MainController?action=ViewDetail&id=${product.productId}"
                                                    class="btn btn-sm btn-outline-primary fw-bold">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <c:otherwise>
                            <div class="col-12 text-center py-5">
                                <h5 class="text-muted">No products available at the moment. Please check back later!
                                </h5>
                            </div>
                        </c:otherwise>
                    </c:choose>
