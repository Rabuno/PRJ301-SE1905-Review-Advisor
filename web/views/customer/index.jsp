            ...
            <%@include file="../../common/header.jsp" %>
                ...
                <div class="container mt-4 mb-5 flex-grow-1">
                    ...
                    <div class="p-5 text-center hero-section shadow-sm mb-5">
                        <h1 class="text-primary fw-bold mb-3"><i class="bi bi-search-heart"></i> Find Your Next Great
                            Stay</h1>
                        ...
                        <form action="${pageContext.request.contextPath}/MainController" method="GET"
                            ...
                            <div class="input-group w-50 shadow-sm">
                                ...
                                <input type="text" name="txtSearch" class="form-control border-start-0 py-2"
                        ...
                        <c:choose>
                            <c:when test="${not empty requestScope.PRODUCT_LIST}">
                                <c:forEach var="product" items="${requestScope.PRODUCT_LIST}">
                                    <div class="col-md-4 mb-4">
                                        <div
                                            class="card h-100 shadow-sm card-product border-0 rounded-3 overflow-hidden">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    ...
                                                    <span
                                                        class="badge bg-success-subtle text-success border border-success rounded-pill">
                                                        ACTIVE
                                                    </span>
                                                </div>
                            ...
                            <c:otherwise>
                                <div class="col-12 text-center py-5 bg-white rounded-3 shadow-sm">
                                    ...
                                    <p class="text-muted">We are currently updating our listings. Please check back
                                        later!</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
